...
ckpt_path="/home/dell/YX/FLUX-task/FlexiAct/exp_outputs/cogvideox-5b-140k-motioninversion-i2v_refnetlora_1e4_use_different_first_frame/checkpoint-22500/pytorch_model.pt"
wo_kv=0
...
export PROJECT_NAME="1024-no-adain-FFT-decapitate_onestage_${motion_type}_${lora_weight}lora_${lora_step}lorasteps"
export MODEL_PATH="/home/dell/YX/FLUX-task/FlexiAct/CogVideoX-5b-I2V" # Please set your CogVideoX-5b-I2V path
...
CUDA_VISIBLE_DEVICES=$visible_devices accelerate launch --config_file $config_file --machine_rank 0 --num_processes $num_processes --main_process_port $main_process_port \
  ...
  --meta_file_path benchmark/captions/Decapitate-it/${motion_type}/crop1.csv \
  --val_meta_file_path benchmark/captions/Decapitate-it/${motion_type}/crop1.csv \
  --validating_steps 5000 \
  --resume_from_checkpoint latest \
  --proportion_empty_prompts $proportion_empty_prompts \
  --ckpt_path $ckpt_path \
  --max_train_steps 1000000 \
  --val_csv_path benchmark/captions/Decapitate-it/${motion_type}/val_image.csv \
  --stage $stage \
  --rank 16 \
  --lora_alpha 32 \
