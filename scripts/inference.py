...
def get_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default="/home/dell/YX/FLUX-task/FlexiAct/CogVideoX-5b-I2V",
        help="The path of the CogVideoX-5b-I2V weights."
    )
    parser.add_argument(
        "--refadapter_ckpt_path",
        type=str,
        default="/home/dell/YX/FLUX-task/FlexiAct/ckpts/refnetlora_step40000_model.pt",
        help="The path of the RefAdapter weights."
    )
    parser.add_argument(
        "--emb_ckpt_path",
        type=str,
        default="/home/dell/YX/FLUX-task/FlexiAct/ckpts/FAE/motion_ckpts/rotation.pt",
    ...
    parser.add_argument(
        "--gt_img_path",
        type=str,
        default="/home/dell/YX/FLUX-task/FlexiAct/benchmark/target_images/human/game_girl_1.webp",
